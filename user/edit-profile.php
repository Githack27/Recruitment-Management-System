                    ...
                    <div class="row">
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="hsc" placeholder="Percentage/CGPA" value="<?php echo $row['ssc']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="Marks">12th Marks</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="ssc" placeholder="Percentage/CGPA" value="<?php echo $row['hsc']; ?>">
                        </div>
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" name="resume" class="btn btn-default" value="<?php echo $row['resume']; ?>">
                        </div>
